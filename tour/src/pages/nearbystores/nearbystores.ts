...
/**
 * Generated class for the NearbystoresPage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-nearbystores',
  templateUrl: 'nearbystores.html',
})
...
getRestaurants(latLng)
{
    ...
    let request = {
        location : latLng,
        radius : 7000,
        types:["jewelry_store","clothing_store","convenience_store","electronics_store","furniture_store","store","hardware_store","home_goods_store","shoe_store"]
    };
